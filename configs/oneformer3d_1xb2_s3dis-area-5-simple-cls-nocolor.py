...
# dataset settings
dataset_type = 'S3DISSimpleSegDataset_'
data_root = 'data/s3dis_simple_classes'
data_prefix = dict(
    pts='points',
...
class_names = [
    'ceiling','floor','wall','window','door','clutter','unlabeled'
]
...
metric_meta = dict(
    ...
    classes=class_names,
    dataset_name='S3DIS')
sem_mapping = [0, 1, 2, 3, 4, 5,]

val_evaluator = dict(
    type='UnifiedSegMetric',
    stuff_class_inds=[0, 1, 2, 3, 5],
    thing_class_inds=[4,],
    min_num_points=1,
    id_offset=2**16,
...
load_from = 'work_dirs/oneformer3d_1xb2_s3dis-area-5-simple-cls-nocolor/best_all_ap_50%_epoch_208.pth'
