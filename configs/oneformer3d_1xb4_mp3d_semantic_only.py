    ...
    criterion=dict(
        ...
        inst_criterion=dict(
            ...
            matcher=dict(
                ...
                costs=[
                    dict(type='QueryClassificationCost', weight=0.005),
                    dict(type='MaskBCECost', weight=0.01),
                    dict(type='MaskDiceCost', weight=0.01)]),
            loss_weight=[0.0001, 0.0001, 0.0001, 0.0001],
            num_classes=num_instance_classes,
            non_object_weight=0.03,
...
data_root = "data/mp3d/oneformer3d"
data_prefix = dict(
    pts='points',
